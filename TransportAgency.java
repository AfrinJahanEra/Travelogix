...
public class TransportAgency {
    ...
    public void menu() {
        ...
        Show_Bus_By_Name showBus = new Show_Bus_By_Name();
        Show_Bus_By_Location showBusByLocation = new Show_Bus_By_Location();
        ...
        while (true) {
            ...
            System.out.println("3. Search for Bus Details (Search by Number plate)");
            System.out.println("4. Delete Bus details (Search by name)");
            System.out.println("5. Show bus by name");
            System.out.println("6. Show bus by location");
            ...
            switch (choice) {
                ...
                case 2:
                    System.out.print("Enter the bus number plate to edit: ");
                ...
                case 3:
                    System.out.print("Enter the bus number plate to search: ");
                    String busNameToSearch = scanner.nextLine();
                    searchBus.search_bus_by_name(busNameToSearch);
                    break;

                case 4:
                    System.out.print("Enter the bus number plate to delete: ");
                    String busNameToDelete = scanner.nextLine();
                    deleteBus.delete_bus(busNameToDelete);
                    break;  // Add break to prevent fall-through

                case 5:
                    System.out.print("Enter the name of of bus: ");
                    String bus_name = scanner.nextLine();

                    showBus.search_bus_by_name(bus_name);
                    break;  // Add break to prevent fall-through
//
                case 6:
                    ...
                    showBusByLocation.search_bus_by_location(start,end);
                    break;  // Add break to prevent fall-through
