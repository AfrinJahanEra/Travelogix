...
public class ApproveRequest {
    ...
    public void approveTransportAgencyRequests() {
        try (BufferedReader reader = new BufferedReader(new FileReader(REQUEST_FILE));
            ...
            System.out.println("\n Error: Request file not found. Please check the file path.");
        } catch (IOException e) {
            System.out.println("\n An error occurred while processing requests.");
        }
    ...
    private void deleteUserAccount(String email) {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(USERS_FILE));
            ...
            System.out.println("\n Error: Users file not found. Please check the file path.");
        } catch (IOException e) {
            System.out.println("\n An error occurred while deleting the user account.");
        }
    ...
    private void replaceFile(String tempFileName, String originalFileName) {
        ...
        if (tempFile.exists()) {
            if (originalFile.delete()) {
                if (tempFile.renameTo(originalFile)) {
                    System.out.println("\n Request file updated successfully.");
                } else {
                    System.out.println("\n Failed to rename the temporary request file.");
                }
            } else {
                System.out.println("\n Failed to delete the original request file.");
            }
        }
    }
}
